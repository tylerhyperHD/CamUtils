...
public class CUtils_NBTFactory
{
    ...
    // Shared instance
    private static CUtils_NBTFactory INSTANCE;
     ...
     * @return The factory.
     */
    private static CUtils_NBTFactory get()
    {
        if(INSTANCE == null)
        {
            INSTANCE = new CUtils_NBTFactory();
        }
        return INSTANCE;
    }
    ...
    private CUtils_NBTFactory()
    {
        if(BASE_CLASS == null)
        {
            try
            {
                ...
                ClassLoader loader = CUtils_NBTFactory.class.getClassLoader();
    ...
    private String getPackageName()
    {
        ...
        {
            // Fallback
            return "org.bukkit.craftbukkit.v1_8_R2";
        }
    }
